                    ...
                    if($resultCheck > 0){
                        while($row = mysqli_fetch_assoc($result)){
                            echo '<tr>';
                                ...
                                echo '<td class="text-center"><a href="includes/process.php?deleteMarketsection='.$row['market_section_id'].'" class="btn btn-danger btn-sm rounded"><i class="fa-solid fa-trash"></i></a></td>';
                            echo '</tr>';
                        }
                    }
                ?>
