...
<div class="height-100 bg-light-gray main-content">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ulu">
                        <li class="nav-item">
                            <a class="nav-link active  fs-6" aria-current="page" href="tconcerns.php"></i>Not Process yet complaints</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="bg-light-gray mb-5 p-3 rounded">
        ...
        <div class="row justify-content-around mb-3 p-2 bg-light bordddd border-4 shadow-sm rounded">
            ...
            ?>
            <?php
            $sql = "SELECT * FROM tconcerns WHERE status = 'Not process yet ' ORDER BY date_time_created DESC;";
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <form method="POST" action="">
                    ...
                    <button type="submit" name="action" class="btn btn-success btn-sm rounded">Take Action</button>
                </form>
            </div>
        </div>
    </div>`;
