    ...
    <div class="height-100 bg-light main-content">
        ...
        <?php
            if(isset($_GET['editMarket'])){
                ...
                echo '<h3 class="text-center"> Add Market</h3>';
            }?><hr>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="row g-3 justify-content-center">
                            <div class="row mb-3">
                                <div class="col-md-9">
                                    <label for=""><small>Market name:</small></label>
                                    <!-- Add hidden input field for the market ID -->
                                    <input type="hidden" name="market_id" value="<?php echo isset($_GET['editMarket']) ? $_GET['editMarket'] : ''; ?>">
                                    <input type="text" class="form-control" id="market" name="market_name" rows="3" value="<?php echo $bmarket; ?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row g-3 justify-content-center mb-4">
                        <div class="col-md-6">
                            <center>
                                <?php
                                    if (isset($_GET['editMarket'])) {
                                        echo '<a href="market.php" class="btn btn-danger btn-sm">Cancel</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="submit" name="market-update" class="btn btn-primary btn-sm">Update</button>';
                                    } else {
                                        echo '<a href="market.php" class="btn btn-danger btn-sm">Cancel</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <button type="submit" name="market-submit" class="btn btn-primary btn-sm">Save</button>';
                                    }
                                ?>
                            </center>
                        </div>
