    ...
    <h3 class="fw-bold text-center"><i class="bi bi-envelope"></i> Send Message</h3><hr>
        ...
        <form action="includes/process.php" method="post" class="row g-1 sform mb-2 shadow" enctype="multipart/form-data">
            <div class="row g-3 justify-content-center">
                <div class="col-md-4">
                    <h3>Send Message to <?php echo $tfname . ' ' . $lname; ?></h3>
                </div>
            </div>
            <div class="row g-3 justify-content-center">
                <div class="col-md-4">
                    <label for="contactNumber" class="form-label">Tenant Contact Number:</label>
                    <input type="text" name="contactNumber" class="form-control form-control-sm" id="contactNumber" placeholder="Tenant contact number..." required value="<?php echo $tphone?>" readonly>
                </div>
            </div>
            <div class="row g-3 justify-content-center">
                <div class="col-md-4">
