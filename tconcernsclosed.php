...
<div class="height-100 bg-light-gray main-content">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ulu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  fs-6" aria-current="page" href="tconcernsadd.php"><strong><i class="bi bi-card-checklist"></i></strong> Pending complaints</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active fs-6" aria-current="page" href="tconcernsclosed.php"><i class='bx bx-bar-chart-alt-2'></i> Closed complaints</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="bg-light-gray mb-5 p-3 rounded">
            ...
            if(isset($_GET['action'])){
                echo '<center><small><div class="text-start alert alert-'.$_GET['action'].' alert-dismissible fade show" role="alert">
                    ...
                    if($_GET['action'] == 'danger')
                        echo '<i class="fa-solid fa-trash"></i>&nbsp; Concerns of '.$_GET['tenantname'].' has been deleted !';
        ...
        ?>     
            ...
            <?php
            $sql = "SELECT * FROM tconcerns WHERE status = 'closed' ORDER BY date_time_created DESC;";
                    ...
                    <tbody>
                        ...
                        if ($resultCheck > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<td class="text-center"><a href="tconcernsclosed.php?view=' . $row['concernid'] . '" class="btn btn-primary btn-sm rounded"><i class="fa-solid fa-eye"></i></a></td>';
